...
let handler = async (m, { conn, text }) => {
  ...
  conn.reply(m.chat, `Selamat @${who.split`@`[0]}. Kamu mendapatkan +${lvl} bibit anggur!`, m, { mentions: [who] }, {
        contextInfo: {
            mentionedJid: [who]
        }
    }) }
}
handler.help = ['addbibitanggur @user <amount>']
handler.tags = ['owner']
handler.command = /^addbibitanggur$/
handler.owner = true
