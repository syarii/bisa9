...
let handler = async (m, { conn, text }) => {
  ...
  conn.reply(m.chat, `Selamat @${who.split`@`[0]}. Kamu mendapatkan +${lvl} bibit pisang!`, m, { mentions: [who] }, {
        contextInfo: {
            mentionedJid: [who]
        }
    }) }
}
handler.help = ['addbibitpisang @user <amount>']
handler.tags = ['owner']
handler.command = /^addbibitpisang$/
handler.owner = true
