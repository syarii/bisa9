...
let handler = async (m, { conn, usedPrefix, text }) => {
	    let time = global.db.data.users[m.sender].lastandika + 1800000
  if (new Date - global.db.data.users[m.sender].lastandika< 1800000) throw `Anda sudah lelah untuk andika\nTunggu selama ${msToTime(time - new Date())} lagi`
